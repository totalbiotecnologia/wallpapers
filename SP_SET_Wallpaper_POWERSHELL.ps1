...
Remove-Item "c:\temp\wallpaper.jpg"

if (Test-Path $FolderName) {
  
	wget -o "c:\temp\wallpaper.jpg" https://github.com/totalbiotecnologia/wallpapers/raw/main/Wallpaper.jpg
